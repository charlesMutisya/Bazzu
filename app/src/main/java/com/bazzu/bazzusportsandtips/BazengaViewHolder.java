...
public class BazengaViewHolder extends RecyclerView.ViewHolder {
    View mnviewd;

    public BazengaViewHolder(View itemView) {
        super(itemView);
        mnviewd = itemView;
    ...
    public void setTitle(String title) {
        TextView tvTitle =  mnviewd.findViewById(R.id.postTitle);
        tvTitle.setText(title);
    }

    public void setDetails(String details) {

        TextView txtdetails = mnviewd.findViewById(R.id.post);
    ...
    public void setTime(Long time) {
        ...
        TextView txtTime = mnviewd.findViewById(R.id.postTime);
